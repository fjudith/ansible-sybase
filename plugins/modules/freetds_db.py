...
---
module: freetds_db
short_description: Add or remove MSSQL/SYBASE databases from a remote host
description:
- Add or remove MSSQL/SYBASE databases from a remote host.
options:
  name:
    description:
  ...
  collation:
    ...
    - Collation mode (sorting). This only applies to new table/databases and
      does not update existing ones, this is a limitation of MSSQL and Sybase.
    type: str
    default: ''
  encoding:
    description:
